  ...
  <div class="row px-xl-5">
    ...
    <div class="col-lg-3 col-md-12">
      ...
      <div class="border-bottom mb-4 pb-4">
        ...
        <form class="row">
          <div
            ...
            <input type="text" class="form-control" checked id="min_price" placeholder="Từ giá" onchange="callFetchPage()">
          </div>
          <div
            class="col-lg-6 custom-control custom-checkbox d-flex align-items-center gap-2 justify-content-between mb-3">
            <input type="text" class="form-control" checked id="max_price" placeholder="Đến giá" onchange="callFetchPage()">
          </div>
        </form>
      </div>
      <!-- Price End -->
      ...
      <div class="border-bottom mb-4 pb-4">
        ...
        <form id="category-form">
          <div class="custom-control custom-checkbox d-flex align-items-center gap-3 mb-3">
            <input type="checkbox" class="custom-control-input" name="Tát cả" checked id="category-all" onclick="callFetchPage('category')">
            <label class="custom-control-label" for="category-all">Tất cả</label>
          </div>
          <div class="custom-control custom-checkbox d-flex align-items-center gap-3 mb-3">
            <input type="checkbox" class="custom-control-input" id="category-1" onclick="callFetchPage()">
            <label class="custom-control-label" for="category-1">Giày nam</label>
          </div>
          <div class="custom-control custom-checkbox d-flex align-items-center gap-3 mb-3">
            <input type="checkbox" class="custom-control-input" id="category-2" onclick="callFetchPage()">
            <label class="custom-control-label" for="category-2">Giày nữ</label>
          </div>
          <div class="custom-control custom-checkbox d-flex align-items-center gap-3 mb-3">
            <input type="checkbox" class="custom-control-input" id="category-3" onclick="callFetchPage()">
            <label class="custom-control-label" for="category-3">Giày thể thao nam</label>
          </div>
          <div class="custom-control custom-checkbox d-flex align-items-center gap-3 mb-3">
            <input type="checkbox" class="custom-control-input" id="category-4" onclick="callFetchPage()">
          ...
          <div class="custom-control custom-checkbox d-flex align-items-center gap-3">
            <input type="checkbox" class="custom-control-input" id="category-5" onclick="callFetchPage()">
      ...
      <div class="border-bottom mb-4 pb-4">
        ...
        <form id="brand-form">
          <div class="custom-control custom-checkbox d-flex align-items-center gap-3 mb-3">
            <input type="checkbox" class="custom-control-input" checked id="brand-all" onclick="callFetchPage('brand')">
            <label class="custom-control-label" for="brand-all">Tất cả</label>
          </div>
          <div class="custom-control custom-checkbox d-flex align-items-center gap-3 mb-3">
            <input type="checkbox" class="custom-control-input" id="brand-1" onclick="callFetchPage()">
            <label class="custom-control-label" for="brand-1">Nike</label>
          </div>
          <div class="custom-control custom-checkbox d-flex align-items-center gap-3 mb-3">
            <input type="checkbox" class="custom-control-input" id="brand-2" onclick="callFetchPage()">
            <label class="custom-control-label" for="brand-2">Puma</label>
          </div>
          <div class="custom-control custom-checkbox d-flex align-items-center gap-3 mb-3">
            <input type="checkbox" class="custom-control-input" id="brand-3" onclick="callFetchPage()">
            <label class="custom-control-label" for="brand-3">Adidas</label>
          </div>
          <div class="custom-control custom-checkbox d-flex align-items-center gap-3 mb-3">
            <input type="checkbox" class="custom-control-input" id="brand-4" onclick="callFetchPage()">
      ...
      <div class="border-bottom mb-4 pb-4">
        ...
        <form id="color-form">
          <div class="custom-control custom-checkbox d-flex align-items-center gap-3 mb-3">
            <input type="checkbox" class="custom-control-input" checked id="color-all" onclick="callFetchPage('color')">
            <label class="custom-control-label" for="color-all">Tất cả</label>
          </div>
          <div class="custom-control custom-checkbox d-flex align-items-center gap-3 mb-3">
            <input type="checkbox" class="custom-control-input" id="color-1" onclick="callFetchPage()">
            <label class="custom-control-label" for="color-1">Đen</label>
          </div>
          <div class="custom-control custom-checkbox d-flex align-items-center gap-3 mb-3">
            <input type="checkbox" class="custom-control-input" id="color-2" onclick="callFetchPage()">
            <label class="custom-control-label" for="color-2">Trắng</label>
          </div>
          <div class="custom-control custom-checkbox d-flex align-items-center gap-3 mb-3">
            <input type="checkbox" class="custom-control-input" id="color-3" onclick="callFetchPage()">
            <label class="custom-control-label" for="color-3">Xanh dương</label>
          </div>
          <div class="custom-control custom-checkbox d-flex align-items-center gap-3 mb-3">
            <input type="checkbox" class="custom-control-input" id="color-4" onclick="callFetchPage()">
            <label class="custom-control-label" for="color-4">Đỏ</label>
          </div>
          <div class="custom-control custom-checkbox d-flex align-items-center gap-3">
            <input type="checkbox" class="custom-control-input" id="color-5" onclick="callFetchPage()">
      ...
      <div class="border-bottom mb-4 pb-4">
        ...
        <form id="size-form">
          <div class="custom-control custom-checkbox d-flex align-items-center gap-3 mb-3">
            <input type="checkbox" class="custom-control-input" checked id="size-all" onclick="callFetchPage('size')">
            <label class="custom-control-label" for="size-all">Tất cả</label>
          </div>
          <div class="custom-control custom-checkbox d-flex align-items-center gap-3 mb-3">
            <input type="checkbox" class="custom-control-input" id="size-1" onclick="callFetchPage()">
            <label class="custom-control-label" for="size-1">38</label>
          </div>
          <div class="custom-control custom-checkbox d-flex align-items-center gap-3 mb-3">
            <input type="checkbox" class="custom-control-input" id="size-2" onclick="callFetchPage()">
            <label class="custom-control-label" for="size-2">39</label>
          </div>
          <div class="custom-control custom-checkbox d-flex align-items-center gap-3 mb-3">
            <input type="checkbox" class="custom-control-input" id="size-3" onclick="callFetchPage()">
            <label class="custom-control-label" for="size-3">40</label>
          </div>
          <div class="custom-control custom-checkbox d-flex align-items-center gap-3 mb-3">
            <input type="checkbox" class="custom-control-input" id="size-4" onclick="callFetchPage()">
            <label class="custom-control-label" for="size-4">41</label>
          </div>
          <div class="custom-control custom-checkbox d-flex align-items-center gap-3">
            <input type="checkbox" class="custom-control-input" id="size-5" onclick="callFetchPage()">
